...
public class AddPersonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText LastName=(EditText) v.findViewById(R.id.PatientLastName);
        final EditText Email=(EditText) v.findViewById(R.id.Email);
        final EditText Age=(EditText) v.findViewById(R.id.PatientAge);
        final EditText Phone=(EditText) v.findViewById(R.id.PatientPhone);
                    ...
                    new Thread() {
                        public void run() {
                            try {
                                ...
                                int result = dbController.AddPatient(FirstName.getText().toString(),
